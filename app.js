...
client.on("message_create", async (msg) => {
  ...
  let got_message = `${t} <GOT MESSAGE> ${
    msg.hasMedia ? "<HAS MEDIA>" : ""
  } <FROM: ${msg.fromMe ? "ME" : msg.author}> <IN: ${msg.from}> | BODY: ${
    body.startsWith("!") ? msg.body : msg.body.substring(0, 16) + "..."
  }`;
  body.startsWith("!") ? log(got_message.magenta) : log(got_message.yellow);
